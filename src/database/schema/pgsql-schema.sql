...
--
-- Name: appointments_booking_doctor_id_seq; Type: SEQUENCE; Schema: public; Owner: test
--

CREATE SEQUENCE public.appointments_booking_doctor_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.appointments_booking_doctor_id_seq OWNER TO test;

--
-- Name: appointments_booking_doctor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: test
--

ALTER SEQUENCE public.appointments_booking_doctor_id_seq OWNED BY public.appointments_booking.doctor_id;
...
--
-- Name: appointments_booking_doctor_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: test
--

ALTER SEQUENCE public.appointments_booking_doctor_user_id_seq OWNED BY public.appointments_booking.doctor_user_id;
...
--
-- Name: appointments_booking_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: test
--

ALTER SEQUENCE public.appointments_booking_id_seq OWNED BY public.appointments_booking.id;
...
--
-- Name: appointments_booking_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: test
--

ALTER SEQUENCE public.appointments_booking_user_id_seq OWNED BY public.appointments_booking.user_id;
...
ALTER TABLE ONLY public.appointments_booking ALTER COLUMN id SET DEFAULT nextval('public.appointments_booking_id_seq'::regclass);


--
-- Name: appointments_booking user_id; Type: DEFAULT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking ALTER COLUMN user_id SET DEFAULT nextval('public.appointments_booking_user_id_seq'::regclass);


--
-- Name: appointments_booking doctor_id; Type: DEFAULT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking ALTER COLUMN doctor_id SET DEFAULT nextval('public.appointments_booking_doctor_id_seq'::regclass);


--
-- Name: appointments_booking doctor_user_id; Type: DEFAULT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking ALTER COLUMN doctor_user_id SET DEFAULT nextval('public.appointments_booking_doctor_user_id_seq'::regclass);
...
--
-- Name: appointments_booking appointments_booking_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking
    ADD CONSTRAINT appointments_booking_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.doctors(id);


--
-- Name: appointments_booking appointments_booking_doctor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking
    ADD CONSTRAINT appointments_booking_doctor_user_id_fkey FOREIGN KEY (doctor_user_id) REFERENCES public.users(id);


--
-- Name: appointments_booking appointments_booking_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.appointments_booking
    ADD CONSTRAINT appointments_booking_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
